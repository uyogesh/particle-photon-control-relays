...
#line 1 "/home/flowing/Documents/projects/sabjiKothi/sk/src/test.ino"
...
void setup();
void loop();
#line 3 "/home/flowing/Documents/projects/sabjiKothi/sk/src/test.ino"
int R1 = D0;
int R2 = D1;
int R3 = D2;
int R4 = D3;
...
public:
  ...
  int feedTimingData(String timingData)
  {
    try
    {
      ...
      std::string *parsedString = parseString(timingData, " ");
      for (int i = 0; i < 4; i++)
      {
        int j = 0;
  ...
  std::string *parseString(std::string s, std::string delimiter)
  {
    std::string *parsedString = new std::string[10];
    std::size_t pos = 0;
    int index = 0;
    std::string token;
